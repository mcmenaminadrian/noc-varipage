...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Tue Jun 13 12:13:02 2017
# Project:  noc-qt.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I/usr/local/include -I/usr/local/include -I. -I. -I/home/adrian/local/include
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents mainwindow.h ControlThread.hpp memory.hpp memorypacket.hpp bus.hpp noc.hpp paging.hpp processor.hpp SAX2Handler.hpp xmlFunctor.hpp tile.hpp .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp ControlThread.cpp memory.cpp memorypacket.cpp bus.cpp noc.cpp numberpage.cpp paging.cpp processor.cpp SAX2Handler.cpp xmlFunctor.cpp tile.cpp .tmp/noc-qt1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/noc-qt1.0.0/ && (cd `dirname .tmp/noc-qt1.0.0` && $(TAR) noc-qt1.0.0.tar noc-qt1.0.0 && $(COMPRESS) noc-qt1.0.0.tar) && $(MOVE) `dirname .tmp/noc-qt1.0.0`/noc-qt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/noc-qt1.0.0
