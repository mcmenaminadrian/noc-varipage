...
const static uint64_t KERNELPAGES = 8;	//2 gives 1k kernel on 512b paging
const static uint64_t STACKPAGES = 8; 	//2 gives 1k stack on 512b paging
const static uint64_t BITMAPDELAY = 0;	//0 for subcycle bitmap checks
const static uint64_t FREEPAGES = 83;	//25 for 512b pages, 12 for 1k pages
const static uint64_t BASEPAGES = 37;	//5 for 512b pages, 3 for 1k pages 
...
const static uint64_t TAB_SHIFT = 7; //9 for 512, 10 for 1024 pages
